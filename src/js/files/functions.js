...
export function scaling() {
  /*! Масштабирование страницы при размере экрана меньше минимального ========================================================================================================================================================*/
  function scalePage() {
    const page = document.documentElement;
    let clientWidth = window.innerWidth;
    const startWidth = 375;
    if (startWidth / 1 && clientWidth <= startWidth) {
      let pageComputedWidth = parseInt(getComputedStyle(page).width);
      let resizeCoef = clientWidth / pageComputedWidth;
      let resizeCoefPercents = 100 * resizeCoef;
