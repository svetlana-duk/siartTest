(() => {
    ...
    (() => {
        ...
        function formFieldsInit(options = {
            ...
            /*! Работа с полями формы. Добавление классов ========================================================================================================================================================*/
            ...
            document.body.addEventListener("focusout", (function(e) {
                ...
                if (targetElement.tagName === "INPUT" || targetElement.tagName === "TEXTAREA") {
                    ...
                    /*! Моментальная валидация ========================================================================================================================================================*/                    targetElement.hasAttribute("data-validate") ? formValidate.validateInput(targetElement) : null;
                }
            }));
            /*! Функционал "Показать пароль" ========================================================================================================================================================*/            if (options.viewPass) document.addEventListener("click", (function(e) {
            ...
            /*! Функционал "Автовысота" ========================================================================================================================================================*/            if (options.autoHeight) {
        ...
        function formSubmit() {
            ...
            /*! Действия после отправки формы ========================================================================================================================================================*/            function formSent(form, responseResult = ``) {
                ...
                /*! Показываем попап ========================================================================================================================================================*/                setTimeout((() => {
                    if (flsModules.popup) {
                        const popup = form.dataset.popupMessage;
                        popup ? flsModules.popup.open(popup) : null;
                    }
                }), 0);
                /*! Очищаем форму ========================================================================================================================================================*/                formValidate.formClean(form);
                ...
                if (targetElement.closest("[data-quantity-plus]") || targetElement.closest("[data-quantity-minus]")) {
                    ...
                    if (targetElement.hasAttribute("data-quantity-plus")) {
                        ...
                        if (+valueElement.dataset.quantityMin) {
                            ...
                            value = 1;
                            targetElement.closest(".card__controls").classList.remove("is-in-cart");
                        }
                    }
        ...
        function initSliders() {
            ...
            if (catalogSliders.length > 0) catalogSliders.forEach((catalogSlider => {
        ...
        if (cardQuickViewBtns.length > 0) cardQuickViewBtns.forEach((cardQuickViewBtn => {
        ...
        /*! Add to cart click ======================================================================================================================================================== */        const cartButtons = document.querySelectorAll(".button--cart");
        if (cartButtons.length > 0) cartButtons.forEach((cartButton => {
